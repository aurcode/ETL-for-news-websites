...
def main(filename):
    ...
    newspaper_uid = _extact_newspaper_uid(filename)
    ...
    df = _drop_rows_wich_missing_values(df)
...
def _extact_newspaper_uid(filename):
...
def _remove_new_lines_from_body(df):
    logger.info('Remove new lines for body')
    stripped_body = (df
...
def _drop_rows_wich_missing_values(df):
